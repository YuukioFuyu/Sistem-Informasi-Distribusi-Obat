    ...
    var e = $("#base_url").val(),
        ...
        l = {
            ...
            source: function (t, l) {
                ...
                $.ajax({
                    url: e + "/invoice/search_sales",
                    method: "POST",
                    dataType: "json",
                    data: { term: t.term, sales_name: n, app_csrf: a },
                    success: function (t) {
                        l(t);
                    },
                });
            ...
            select: function (t, e) {
                $(this).parent().parent().find("#sales_id").val(e.item.value);
                return $(this).unbind("change"), !1;
            },
        };
    $("body").on("keypress.autocomplete", "#sales_name", function () {
        $(this).autocomplete(l);
    });
}
