 ...
 #------------------------------------    
    ...
    public function update_setting(){
        ...
        if($this->validation->withRequest($this->request)->run() && $this->request->getFile('favicon')){
            ...
            'npwp'         => $this->request->getVar('npwp', FILTER_SANITIZE_STRING),
            'cdob'         => $this->request->getVar('cdob', FILTER_SANITIZE_STRING),
            'pbf'          => $this->request->getVar('pbf', FILTER_SANITIZE_STRING),
