 ...
 #------------------------------------    
    ...
    public function update_setting(){
        ...
        if($this->validation->withRequest($this->request)->run() && $this->request->getFile('favicon')){
            ...
            'tin'          => $this->request->getVar('tin', FILTER_SANITIZE_STRING),
            'gdp'          => $this->request->getVar('gdp', FILTER_SANITIZE_STRING),
            'pbd'          => $this->request->getVar('pbd', FILTER_SANITIZE_STRING),
