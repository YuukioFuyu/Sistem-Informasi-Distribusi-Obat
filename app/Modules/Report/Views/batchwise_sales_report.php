        ...
        <div class="card ">
            <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="fs-17 font-weight-600 mb-0"><?php echo lan('batchwise_sales_report')?></h6>
                                </div>
             ...
             <div class="row">
                  <div class="col-sm-12">
                          <form action="" class="form-inline" method="post" accept-charset="utf-8">
                              ...
                              <?php echo  form_dropdown('batch_id',$batch_list,null, 'class="form-control select2" id="batch_id"') ?> 
                                  </div>
                ...
                <div class="table-responsive">
                     <table class="table table-striped table-bordered custom-table" cellspacing="0" width="100%" id="batchWiseSalesreport"> 
                <thead>
                  <tr>
                    <th><?php echo lan('sl_no') ?></th>
                    <th><?php echo lan('date') ?></th>
                    <th><?php echo lan('medicine_name') ?></th>
                    <th><?php echo lan('batch_id') ?></th>
